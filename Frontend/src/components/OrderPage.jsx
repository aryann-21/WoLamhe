...
const OrderPage = () => {
  ...
  const uploadToCloudinary = async (file) => {
    ...
    try {
      const response = await axios.post(
        "https://api.cloudinary.com/v1_1/duwjb0moz/image/upload",
        formData
      );
  ...
  const handlePlaceOrder = async () => {
    try {
      ...
      const response = await axios.post(
        "https://wolamhe-3.onrender.com/api/orders",
        orderData,
        {
          headers: {
  ...
  return (
    <div className="min-h-screen bg-[#FDF6F0] p-4 md:p-6 pt-[120px] md:pt-[140px]">
      ...
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl md:text-3xl font-bold text-[#2E2210] mb-6 md:mb-8">
          Your Order
        </h1>
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow-md p-4 md:p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-[#2E2210]">
                  Order Summary
                </h2>
              </div>
            ...
            {cartItems.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {cartItems.map((item, index) => (
                  <div
                    key={index}
                    className="bg-[#eee1cf] rounded-lg p-4 flex flex-col relative group"
                  >
              ...
              <div className="bg-[#ebe1d2]/50 rounded-lg p-8 text-center">
                ...
                <button
                  onClick={() => navigate("/")}
                  className="mt-4 text-[#C4A381] hover:text-[#af8a6c] font-medium"
                >
                  Continue Shopping
                </button>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-[#2E2210]">
                    Delivery Address
                  </h3>
                </div>
              ...
              {/* Payment Section */}
              <div>
                <h3 className="text-lg font-semibold mb-3 text-[#2E2210]">
                  Payment
                </h3>
                ...
                <div
                  className={`border-2 border-dashed rounded-md p-4 text-center transition-colors ${
                    paymentScreenshot
                      ...
                      : "border-gray-300 hover:border-[#C4A381]"
                  }`}
                >
                  {paymentScreenshot ? (
                ...
                <div className="space-y-2">
                  ...
                  {deliveryCharge === 0 && (
                    <div className="text-sm text-green-600 flex items-center">
                      ...
                      {selectedAddress === "NITJ"
                        ? "Free delivery for NITJ"
                  ...
                  <div className="flex justify-between items-center font-bold">
                    ...
                    <span className="text-xl text-[#2E2210]">
                      ₹{grandTotal}
                    </span>
                  </div>
                </div>
