...
app.get("/auth/google/callback", (req, res, next) => {
  ...
  try {
    ...
    const frontendUrl = process.env.FRONTEND_URL || "https://https://wolamhe-4.onrender.com"
...
app.post("/signup", async (req, res) => {
  try {
    ...
    const baseUrl = process.env.FRONTEND_URL || "https://https://wolamhe-4.onrender.com"
